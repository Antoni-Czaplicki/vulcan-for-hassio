...
def get_lesson_info(self, days_to_add=0):
    ...
    for Lesson in client.get_lessons(datetime.date.today() + timedelta(days=days_to_add)):
        temp_dict = {}
        ...
        elif 'odwołana' in temp_dict['changes'] or 'Okienko' in temp_dict['changes'] or 'nieobecność' in temp_dict['changes'] or 'okienko' in temp_dict['changes']: 
    ...
    lesson_ans = {}
    if self.lesson_1 ==  {}:
        self.lesson_1 = {'number': 1, 'lesson': '-', 'room': '-', 'group': '-', 'teacher': '-', 'time': '-', 'changes': '-'}
    if self.lesson_2 ==  {}:
        self.lesson_2 = {'number': 2, 'lesson': '-', 'room': '-', 'group': '-', 'teacher': '-', 'time': '-', 'changes': '-'}
    if self.lesson_3 ==  {}:
        self.lesson_3 = {'number': 3, 'lesson': '-', 'room': '-', 'group': '-', 'teacher': '-', 'time': '-', 'changes': '-'}
    if self.lesson_4 ==  {}:
        self.lesson_4 = {'number': 4, 'lesson': '-', 'room': '-', 'group': '-', 'teacher': '-', 'time': '-', 'changes': '-'}
    if self.lesson_5 ==  {}:
        self.lesson_5 = {'number': 5, 'lesson': '-', 'room': '-', 'group': '-', 'teacher': '-', 'time': '-', 'changes': '-'}
    if self.lesson_6 ==  {}:
        self.lesson_6 = {'number': 6, 'lesson': '-', 'room': '-', 'group': '-', 'teacher': '-', 'time': '-', 'changes': '-'}
    if self.lesson_7 ==  {}:
        self.lesson_7 = {'number': 7, 'lesson': '-', 'room': '-', 'group': '-', 'teacher': '-', 'time': '-', 'changes': '-'}
    if self.lesson_8 ==  {}:
        self.lesson_8 = {'number': 8, 'lesson': '-', 'room': '-', 'group': '-', 'teacher': '-', 'time': '-', 'changes': '-'}
    if self.lesson_9 ==  {}:
        self.lesson_9 = {'number': 9, 'lesson': '-', 'room': '-', 'group': '-', 'teacher': '-', 'time': '-', 'changes': '-'}
    if self.lesson_10 ==  {}:
        self.lesson_10 = {'number': 10, 'lesson': '-', 'room': '-', 'group': '-', 'teacher': '-', 'time': '-', 'changes': '-'}
...
def get_latest_attendance(self):
    ...
    for attendance in client.get_attendance():
        if attendance.category != None:
            ...
            temp_dict['lesson_time'] = attendance.time.from_.strftime("%H:%M") + '-' + attendance.time.to.strftime("%H:%M")
            temp_dict['datetime'] = datetime.datetime.combine(attendance.date, attendance.time.from_)

        setattr(self, 'latest_attendance', temp_dict)
                    
    if self.latest_attendance ==  {}:
        self.latest_attendance = {'content': '-', 'lesson_name': '-', 'lesson_number': '-', 'lesson_date': '-', 'lesson_time': '-', 'datetime': '-'}
...
def get_latest_grade(self):
    ...
    if self.latest_grade ==  {}:
        self.latest_grade = {'content': '-', 'date': '-', 'weight': '-', 'description': '-', 'subject': '-', 'teacher': '-', 'value': 0}
